...
const GAME_GATEWAY_ADDRESS = '0xa76686FD684E85c3ca850196CFdd506378bb4093'; // Your contract address
const CORE_TESTNET_RPC = "https://rpcv2-testnet.ancient8.gg/"; // Core Blockchain testnet RPC
...
const Home: React.FC = () => {
        ...
        if (window.ethereum) {
            try {
                ...
                await window.ethereum.request({
                    ...
                    params: [{
                        chainId: '0x1ad1ba8',  // Core Blockchain Testnet chainId (9059 in decimal)
                        chainName: 'a8-testnet',
                        nativeCurrency: {
                            name: 'Ancient8',
                            symbol: 'ETH',
                            decimals: 18
    ...
    const instances = [
        "0xfeF7d728FD8F617562c08Cd36A69Ab7E78897243" // Newly deployed Game contract
      ]; // Array of instances
